...
/**
 * print_array - print the content of an arr.
 * @array: source of array to print.
 * @s: left index of array.
 * @b: right index of arr.
 */
 ...
 *
 * Return: first index of value in arr, otherwise -1.
 */
...
/**
 * exponential_search - searches value sorted arr using \
 * an exponential search.
 * @array: array to search in.
 * @size: length of the arr.
 * @value: value to look for.
 *
 * Return: index of value in arr, otherwise -1.
 */
